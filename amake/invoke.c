...
**
**  -- fixed null pointer bug in AllocInputs (due to Amakefile errors)
**
**
...
struct slist *inputs;
{
    ...
    /*
    ** Due to lexical errors in the Amakefile, it's possible that
    ** obj is a NULL pointer. Exit with FatalError.
    */
    
    if(obj==NULL) 
        FatalError("AllocInputs: inconsistent object. Check your Amakefiles.");    
