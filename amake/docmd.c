 ...
 */
PRIVATE int DefaultSingleTasking = TRUE;	/* default tasking state */
PUBLIC int SingleTasking = TRUE;		/* current tasking state */
...
#define NPROC_DEF 1	    /* default number */
...
int n;
{
	...
	SingleTasking = DefaultSingleTasking = FALSE;
	nproc = n;
    } else {
