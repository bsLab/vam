...
class base (deleg : WX_base.t) =
  object 
    ...
    method pixmap_get = deleg#pixmap_get
    method image_make = deleg#image_make
    method image_get = deleg#image_get
...
class image (deleg : WX_image.t) =
  object (self)
    method set_imagebuf = deleg#set_imagebuf
    method modified = deleg#modified
end
