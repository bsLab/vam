...
let info_tab = new VX_texttable.t hbox#container info_tab attr  
...
let attr = [
    ...
    Cols [|
        [| 
            [Border [Sides [B_left;B_top;B_right]];
             Width 80;];
            [Border [Sides [B_top;B_right]];
             Width 50;];
        |];
        [| 
            [Align Top; Border [Sides [B_left;B_top;B_right]];
             Width 50;Text_style Bold];
            [Rown 0; Border [Sides [B_top;B_right;]];
        ...
        [| 
            [
             ...
             Width 50;Text_style Bold];
            [
             Border [Sides [B_top;B_right;B_bottom]];
             Width 80;
             But [Widget info_tab#contained;
                  Frame ReliefRaised;
                  Color "lightblue";Size 17];
            ];
        |];
...
let tab = new VX_texttable.with_root hbox#container root tab_cont attr  
...
let _ =
    ...
    top#configure [Bindings [
        EnterWindow,(fun _ ->
            ...
            begin
                printed := true;
                print_eps "texttable14.eps" 1.0 vbox#contained;
            end;
            );   
        ]];   
