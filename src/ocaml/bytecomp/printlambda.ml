...
(* $Id: printlambda.ml,v 1.43 2001/02/19 20:27:36 maranget Exp $ *)
...
let print_matrix name kind ppf layout =
  fprintf ppf "Matrix.%s[%s,%s]"
    name
    (match kind with
     | Pmatrix_unknown -> "generic"
     | Pmatrix_float32 -> "float32"
     | Pmatrix_float64 -> "float64"
     | Pmatrix_sint8 -> "sint8"
     | Pmatrix_uint8 -> "uint8"
     | Pmatrix_sint16 -> "sint16"
     | Pmatrix_uint16 -> "uint16"
     | Pmatrix_int32 -> "int32"
     | Pmatrix_int64 -> "int64"
     | Pmatrix_caml_int -> "camlint"
     | Pmatrix_native_int -> "nativeint")
    (match layout with
    |  Pmatrix_unknown_layout -> "unknown"
     | Pmatrix_c_layout -> "C"
     | Pmatrix_fortran_layout -> "Fortran")
...
let primitive ppf = function
  ...
  | Pmatrixref(n, kind, layout) -> print_matrix "get" kind ppf layout
  | Pmatrixset(n, kind, layout) -> print_matrix "set" kind ppf layout
