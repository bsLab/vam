...
/*
** For improved Backtracing. Save the VM pc before entering an external
** C function. 
*/
code_t extern_pc;
code_t exc_ccall_pc=NULL;
...
#define Setup_for_c_call { *--sp = env; extern_sp = sp; extern_pc = pc;}
#define Restore_after_c_call { sp = extern_sp; env = *sp++; extern_pc = NULL;}
...
*/
    ...
    raise_exception:
      ...
      /*
      ** Raised within a C function ?
      ** Save the location.
      */
      if (extern_pc > 0) 
        exc_ccall_pc = extern_pc;
