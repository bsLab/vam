...
val readb : file_descr -> buf:buffer -> pos:int -> len:int -> int
(** [read fd buff ofs len] reads [len] characters from descriptor
   [fd], storing them in string [buff], starting at position [ofs]
   in string [buff]. Return the number of characters actually read. *)

val writeb : file_descr -> buf:buffer -> pos:int -> len:int -> int
(** [write fd buff ofs len] writes [len] characters to descriptor
   [fd], taking them from string [buff], starting at position [ofs]
   in string [buff]. Return the number of characters actually
   written. *)
...
val wait_timed_read : file_descr -> float -> bool
val wait_timed_write : file_descr -> float -> bool
