...
val putenv : name:string -> value:string -> unit
...
val waitpid : wait_flag list -> pid:int -> int * process_status
...
val lseek : fd:file_descr -> pos:int -> cmd:seek_command -> int
(** Set the current position for a file descriptor *)

val truncate : name:string -> size:int -> unit
(** Truncates the named file to the given size. *)

val ftruncate : fd:file_descr -> size:int -> unit
...
val rename : oldname:string -> newname:string -> unit
...
val fchmod : fd:file_descr -> perm:file_perm -> unit
(** Change the permissions of an opened file. *)

val chown : name:string -> uid:int -> gid:int -> unit
(** Change the owner uid and owner gid of the named file. *)

val fchown : fd:file_descr -> uid:int -> gid:int -> unit
...
val mkdir : name:string -> perm:file_perm -> unit
...
val mkfifo : name:string -> perm:file_perm -> unit
...
val create_process :
  prog:string -> 
  args:string array -> 
  new_stdin:file_descr -> 
  new_stdout:file_descr -> 
  new_stderr:file_descr -> 
  int
...
val close_process : inout:(in_channel * out_channel) -> process_status
...
val lockf : fd:file_descr -> cmd:lock_command -> size:int -> unit
...
val utimes : name:string -> time_acc:float -> time_mod:float -> unit
...
val listen : fd:file_descr -> pend_req:int -> unit
...
val tcflush : fd:file_descr -> queue:flush_queue -> unit
...
val tcflow : fd:file_descr -> action:flow_action -> unit
...
(*
** Some utils from the Thread module
*)

val wait_timed_read : fd:file_descr -> tmo:float -> bool
val wait_timed_write : fd:file_descr -> tmo:float -> bool
