...
enum linda_data_type {
    ...
    I,  /* integer  */
    F,  /* float    */
    CA, /* buffer(char array */
    IA, /* Integer array  (C-format) */
...
static int data_type(value v)
{
    ...
    else if (Is_block(v))
    {
        ...
        switch (tag) {
            ...
            case Custom_tag:
            {
                struct custom_operations * op=Custom_ops_val(v);
                if (strcmp(op->identifier,"_buffer") == 0)
                    return CA;
                if (strcmp(op->identifier,"_matrix") == 0)
                {
...
ext_out_tn (linda_tsid ts,int n,value att)
{
    ...
    for(i=0;i<n;i++)
    {
      ...
      switch (data_type(at)) {
        ...
        case CA:
        {
                struct caml_buf *buf=Buf_val(at);
                addr=(int)buf->data;
                memcpy(&args[argp],(char *)(&addr),sizeof(char *));
                argp=argp+sizeof(char *);
                memcpy(&args[argp],(char *)(&buf->size),sizeof(Linda_int));
                argp=argp+sizeof(int);

                sprintf(&fmt[fmtp],"%s","*c:d");
                fmtp=fmtp+4;
                break;
        };
        case IA:
        {
                caml_matrix_p mat=Matrix_val(at);
                int size=1;
                int j;
                for(j=0;j<mat->dim;j++)
                    size=size*mat->size[j];

                addr=(int)mat->data;
                memcpy(&args[argp],(char *)(&addr),sizeof(int *));
                argp=argp+sizeof(char *);
                memcpy(&args[argp],(char *)(&size),sizeof(Linda_int));
                argp=argp+sizeof(int);

                sprintf(&fmt[fmtp],"%s","*d:d");
                fmtp=fmtp+4;
                break;
        };
        default:
...
CAMLexport value
ext_out_t4 (value att)
{
    return ext_out_tn(NOMS,4,att);
};

CAMLexport value
ext_out_t5 (value att)
{
    return ext_out_tn(NOMS,5,att);
};

CAMLexport value
ext_out_t6 (value att)
{
    return ext_out_tn(NOMS,6,att);
};

CAMLexport value
ext_out_t7 (value att)
{
    return ext_out_tn(NOMS,7,att);
};

CAMLexport value
ext_out_t8 (value att)
{
    return ext_out_tn(NOMS,8,att);
};

CAMLexport value
ext_out_t9 (value att)
{
    return ext_out_tn(NOMS,9,att);
};

CAMLexport value
ext_out_t10 (value att)
{
    return ext_out_tn(NOMS,10,att);
};
...
CAMLexport value
ext_out_t4_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,4,att);
};

CAMLexport value
ext_out_t5_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,5,att);
};

CAMLexport value
ext_out_t6_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,6,att);
};

CAMLexport value
ext_out_t7_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,7,att);
};

CAMLexport value
ext_out_t8_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,8,att);
};

CAMLexport value
ext_out_t9_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,9,att);
};

CAMLexport value
ext_out_t10_ms (value vtsid,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_out_tn(ts,10,att);
};
...
ext_inrd_tn (char type,linda_tsid ts,int n,value ktt,value att)
{
    ...
    */
        ...
        for(i=0;i<n;i++)
        {
            ...
            switch (data_type(at)) {
                ...
                case CA:
                {
                    ...
                    {
                        /*
                        ** We have an alreay allocated buffer!
                        */
                        Store_field(ret_att,i,at);
                        memp=memp+sizeof(int *);
                    };
                    break;
                };
                case IA:
    ...
    else for(i=0;i<n;i++) Store_field(ret_att,i,Field(att,i));
...
CAMLexport value
ext_in_t4 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,4,ktt,att);
};

CAMLexport value
ext_in_t5 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,5,ktt,att);
};

CAMLexport value
ext_in_t6 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,6,ktt,att);
};

CAMLexport value
ext_in_t7 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,7,ktt,att);
};

CAMLexport value
ext_in_t8 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,8,ktt,att);
};

CAMLexport value
ext_in_t9 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,9,ktt,att);
};

CAMLexport value
ext_in_t10 (value ktt,value att)
{
    return ext_inrd_tn('i',NOMS,10,ktt,att);
};
...
CAMLexport value
ext_in_t4_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,4,ktt,att);
};

CAMLexport value
ext_in_t5_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,5,ktt,att);
};

CAMLexport value
ext_in_t6_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,6,ktt,att);
};

CAMLexport value
ext_in_t7_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,7,ktt,att);
};

CAMLexport value
ext_in_t8_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,8,ktt,att);
};

CAMLexport value
ext_in_t9_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,9,ktt,att);
};

CAMLexport value
ext_in_t10_ms (value vtsid,value ktt,value att)
{
    linda_tsid ts=Int_val(vtsid);
    return ext_inrd_tn('i',ts,10,ktt,att);
};
...
ext_linda_cap(value pname)
{
    ...
    */
    err=linda_port(name,&getcap.cap_port);
    if (err != STD_OK) 
        failwith("linda_cap: linda_port failed");

    /*
    ** Make public version
    */
    priv2pub(&getcap.cap_port,
             &putcap.cap_port);
    ...
    */
    ...
    {
        putcap.cap_priv=cap.cap_priv;
    };

    obj_val = ((unsigned char)putcap.cap_priv.prv_object[0])        |
               ((unsigned char)putcap.cap_priv.prv_object[1] << 8)  |
               ((unsigned char)putcap.cap_priv.prv_object[2] << 16) ;

    /* 
    ** Build the private structure 
    */
    Store_field(priv_r,0,Val_int((int)putcap.cap_priv.prv_rights));
    Store_field(priv_o,0,Val_int(obj_val));
    memcpy(String_val(priv_p_s),
               &putcap.cap_priv.prv_random,
               PORTSIZE);
    ...
    memcpy(String_val(port_s),&putcap.cap_port,PORTSIZE);
