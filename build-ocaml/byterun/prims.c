...
extern value caml_set_stdout_callback();
extern value caml_set_stderr_callback();
...
extern value debug_add_compunit();
extern value print_backtrace();
extern value print_backtrace_mode();
...
extern value sys_get_sys_config();
